...
public class WmsTransaction implements Serializable {
	...
	/**来源总单创建时间*/
	@Excel(name = "来源总单创建时间", width = 15, format = "yyyy-MM-dd")
	...
	/**来源细单创建时间*/
	@Excel(name = "来源细单创建时间", width = 15, format = "yyyy-MM-dd")
	@JsonFormat(timezone = "GMT+8",pattern = "yyyy-MM-dd")
	@DateTimeFormat(pattern="yyyy-MM-dd")
    private Date sourcedtlCreateTime;
	/**来源细单创建人*/
