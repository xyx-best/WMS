    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="来源单号" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'socureDtlno', validatorRules.socureDtlno]" placeholder="请输入来源单号"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'rackingId','rackingCode','rackingState','socureDtlno','areaId','areaCode','locId','locCode','locName','goodsId','goodsCode','goodsName','goodsSize','goodsUnit','goodsType','goodsColor','goodsBatchnumber','goodsQuantity','goodsLevel','stockinTime','createTime'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'rackingId','rackingCode','rackingState','socureDtlno','areaId','areaCode','locId','locCode','locName','goodsId','goodsCode','goodsName','goodsSize','goodsUnit','goodsType','goodsColor','goodsBatchnumber','goodsQuantity','goodsLevel','stockinTime','createTime'))
      }
